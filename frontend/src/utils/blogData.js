...
id: '4',
  ...
  {
   id: '5',
  title: 'Asistencia Familiar: Ejecución y Modificación de Pensiones Alimenticias',
  excerpt: 'Procedimientos para fijar, ejecutar y modificar pensiones alimenticias, incluyendo medidas coercitivas como embargos y apremios corporales',
  author: 'Dra. Luciane Cuellar',
  date: '25 Ene 2024',
  category: 'Derecho de Familia',
  readTime: '3 min read',
  content: [
    {
      ...
      paragraphs: [
        'La pensión alimenticia se determina considerando las necesidades del beneficiario y la capacidad económica del obligado.',
        'El juez analiza gastos de educación, salud, vivienda, alimentación y vestimenta para establecer un monto justo y proporcional.'
      ]
    },
    {
      subtitle: 'Procedimiento de Ejecución',
      paragraphs: [
        'Cuando existe incumplimiento en el pago, se puede iniciar un proceso de ejecución que incluye:',
        '• Embargo de bienes: Cuentas bancarias, vehículos o propiedades',
        '• Retención salarial: Hasta el 50% del sueldo del deudor',
        '• Apremio corporal: Prisión como última medida coercitiva',
        '• Multas progresivas: Sanciones económicas por mora'
      ]
    },
    {
      subtitle: 'Modificación de la Pensión',
      paragraphs: [
        'La pensión puede modificarse cuando:',
        '• Cambian las necesidades del beneficiario (ej: ingreso a la universidad)',
        '• Varía la capacidad económica del obligado (pérdida de empleo)',
        '• Ocurren cambios en la situación familiar de ambas partes',
        '• Existen gastos extraordinarios no previstos inicialmente'
      ]
    },
    {
      subtitle: 'Medidas Cautelares Inmediatas',
      paragraphs: [
        'En casos de urgencia, se pueden solicitar medidas cautelares como:',
        '• Embargo preventivo de bienes',
        '• Retención provisional de salarios',
        '• Prohibición de enajenar propiedades',
        'Estas medidas garantizan el cumplimiento mientras se resuelve el proceso principal.'
      ]
    }
  ]
  },
  ...
  content: [
    {
      ...
      paragraphs: [
        'Las medidas cautelares son disposiciones judiciales urgentes que se dictan para garantizar el cumplimiento de una obligación alimenticia mientras se resuelve el proceso principal.',
        'Tienen carácter provisional y se otorgan cuando existe riesgo de que el deudor oculte o disperse sus bienes.'
      ]
    },
    {
      subtitle: 'Requisitos para solicitarlas',
      paragraphs: [
        'Para obtener medidas cautelares se debe demostrar:',
        '• Fumus boni iuris: Existencia aparente del derecho a los alimentos',
        '• Periculum in mora: Riesgo de que la demracia cause perjuicio irreparable',
        '• Relación de causalidad: Entre la medida solicitada y la protección necesaria'
      ]
    },
    {
      subtitle: 'Tipos de medidas cautelares disponibles',
      paragraphs: [
        '• Embargo preventivo: Sobre cuentas bancarias, salarios o bienes del deudor',
        '• Retención de haberes: Hasta el 50% del sueldo o ingresos mensuales',
        '• Prohibición de enajenar: Inmovilización de propiedades y vehículos',
        '• Anotación preventiva: Registro en derechos reales sobre bienes inmuebles'
      ]
    },
    {
      subtitle: 'Procedimiento de solicitud',
      paragraphs: [
        'La solicitud se presenta ante el Juez de Familia con:',
        '• Demanda principal de alimentos o ejecución',
        '• Pruebas del incumplimiento (estados de cuenta, notificaciones)',
        '• Información sobre bienes e ingresos del deudor',
        '• Certificado de nacimiento del beneficiario',
        'El juez debe resolver en un plazo máximo de 72 horas.'
      ]
    },
    {
      subtitle: 'Duración y efectos',
      paragraphs: [
        'Las medidas cautelares mantienen su vigencia hasta que:',
        '• Se dicte sentencia definitiva en el proceso principal',
